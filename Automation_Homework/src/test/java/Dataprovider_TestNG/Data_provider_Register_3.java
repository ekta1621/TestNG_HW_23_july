...
public class Data_provider_Register_3 {
public WebDriver driver;
	
	@Test(priority=1, dataProvider = "TN_Register5", dataProviderClass = Data_provider_register_HW.class)
	...
	@Test(priority=2, dataProvider = "TN_Register6", dataProviderClass = Data_provider_register_HW.class)
