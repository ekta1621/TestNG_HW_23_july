...
public class Data_provider_Register_2 {
public WebDriver driver;
	
	@Test(priority=1, dataProvider = "TN_Register3", dataProviderClass = Data_provider_register_HW.class)
	...
	@Test(priority=2, dataProvider = "TN_Register4", dataProviderClass = Data_provider_register_HW.class)
